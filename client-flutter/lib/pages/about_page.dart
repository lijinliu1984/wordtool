...
class AboutPage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCard(
              ...
              child: Column(
                children: [
                  _buildFeature(context, '学段 + 分类双维度筛选词库'),
                  _buildFeature(context, '单词支持关联音频和图片'),
                  _buildFeature(context, '从服务器加载词库，离线缓存使用'),
                  _buildFeature(context, '翻译练习、听力练习（听音选图/选词）'),
                  _buildFeature(context, '默写练习（听音/看图/看译文 输入单词）'),
                  _buildFeature(context, '练习记录自动保存，支持历史回顾'),
                  _buildFeature(context, '图片音频边看边缓存，流畅体验'),
                ],
              ),
            ),
            ...
            _buildCard(
              ...
              child: Column(
                children: [
                  _buildInfoRow(context, '开发团队', '萍乡市湘东区疯码信息工作室'),
                  const SizedBox(height: 14),
                  _buildInfoRow(context, '联系邮箱', '119030533@qq.com'),
                ],
              ),
            ),
  ...
  static Widget _buildFeature(BuildContext context, String text) {
    final textColor = Theme.of(context).colorScheme.onSurface;
    return Padding(
